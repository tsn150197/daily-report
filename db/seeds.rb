...
Trainer.first.create_user_profile name: "TraineR TEST", gender: 1,
  birthday: "2015-09-22", address: "Hiệp Hòa - Bắc Giang", phone: "0963097932"
...
(1...50).each do |n|
  ...
  user.create_user_profile name: name, birthday: "2015-09-22"
end
(50...100).each do |n|
  name = Faker::Name.name
  email = "test-#{n+1}@test.com"
...
Trainee.first.reports.first.update status: "approved"
