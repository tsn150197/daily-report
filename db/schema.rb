...
ActiveRecord::Schema.define(version: 2019_02_27_153140) do

  create_table "ck_images", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "ck_image"
    t.string "uuid"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["uuid"], name: "index_ck_images_on_uuid"
  end
